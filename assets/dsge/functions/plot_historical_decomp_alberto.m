function plot_historical_decomp_alberto(M_,oo_,dates,vars,var_labels,start)
    % Simplified figure
    supply_shocks    = {'Z'; 'mu_w'; 'mu_p'; 'zeta'; 'covid_mu_w'; 'covid_mu_p'; 'covid_zeta'; 'covid_Gamma'};
    demand_shocks    = {'chi'; 'covid_chi'; 'G'; 'Tb'; 'covid_Gshock'; 'covid_Tb'; 'mp'; 'Pi_tgt'; 'covid_mp'; 'nx'; 'risk'; 'risk_bgg'};
    other_shocks     = {};
    ...
    for ii = 1:size(vars,1)
        ...
        title(strcat(var_labels{ii}, ', structural classification'))
        colororder("gem12")

        fig_name = strcat('figures/shock_decomp_',num2str(start),'_',currvar,'_alberto.png');
